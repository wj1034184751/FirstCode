namespace MyEFModel
{
    ...
    public partial class MyTest : DbContext
    {
        public MyTest()
            : base("name=MyTest")
        {
        ...
        public virtual DbSet<CustomerNo> CustomerNo { get; set; }
        public virtual DbSet<GroupByCommodity> GroupByCommodity { get; set; }
        ...
        public virtual DbSet<RoundTable> RoundTable { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RoundTable>()
                .Property(e => e.IntCount)
                .HasPrecision(10, 5);

            modelBuilder.Entity<RoundTable>()
                .Property(e => e.GuidCount)
                .IsUnicode(false);
        }
    }
}
